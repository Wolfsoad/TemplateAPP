...
namespace STRACT.Data.Migrations
{
    ...
    [Migration("20211016132007_INITIAL")]
            ...
            modelBuilder.Entity("STRACT.Entities.Kanban.TaskItem", b =>
                {
                    ...
                    b.HasOne("STRACT.Entities.HumanResources.Department", "RequestedFrom")
                        .WithMany("TaskItems")
                    ...
                    b.HasOne("STRACT.Entities.Users.UserInTeam", null)
                        .WithMany("TaskItems")
                        .HasForeignKey("UserInTeamId");
