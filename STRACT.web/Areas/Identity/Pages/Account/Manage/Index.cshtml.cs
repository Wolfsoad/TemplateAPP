...
namespace STRACT.web.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            #region UserName changing option - limit message
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            #region UserName changing option
            // Comment this region if no username change is allowed
            // Change control for Username input in HTML
